...
class Python extends React.PureComponent {
    render() {
        return (
            <svg width="5em" height="5em" viewBox="0 0 256 255" 
            ...
            </linearGradient><linearGradient x1="19.128%" y1="20.579%" x2="90.742%" y2="88.429%" id="b">
